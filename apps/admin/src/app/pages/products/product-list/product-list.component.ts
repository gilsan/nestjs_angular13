...
import { CategoriesService, IImage, IProduct, IReview, ProductsService } from '@ngshop/products';
...
export class ProductListComponent implements OnInit {
  ...
  productColumns: string[] = ['name', 'image', 'price', 'countInStock', 'category', 'dateCreated', 'editdelete'];
  products: IProduct[] = [];
  images: IImage[] = [];
  reviews: IReview[] = [];
  ...
  orderitemData = [{
    ...
    "_id": {
      "$oid": "6072d3df3abd910cb7358aa6"
    },
    "quantity": 3,
    "product": {
      "$oid": "5feb21d36bf6622c9ed0d8b4"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "6072d3df3abd910cb7358aa7"
    },
    "quantity": 1,
    "product": {
      "$oid": "5fc64daaf2915285fc565034"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "6072d4e83abd910cb7358aab"
    },
    "quantity": 3,
    "product": {
    ...
    "_id": {
      "$oid": "609d7ee93373711346c5e951"
    },
    "quantity": 7,
    "product": {
      "$oid": "5f68fd316170530b7e0afc54"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "609d7ee93373711346c5e952"
    },
    "quantity": 4,
    "product": {
      "$oid": "5f15da13e520d44421ed8e9e"
    ...
    "_id": {
      "$oid": "609d8a0c3373711346c5e95b"
    },
    "quantity": 1,
    "product": {
      "$oid": "5f15da135420d44456ed8e9e"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "609d8a0c3373711346c5e95a"
    },
    "quantity": 1,
    "product": {
      "$oid": "5f15da135420d44443ed8e9e"
    },
    "__v": 0
  }];
  ...
  orderData = [{
    ...
    "totalPrice": 1240.9,
    "user": {
      "$oid": "5f1687e1be2e99a158c08504"
    },
    "dateOrdered": {
      "$date": "2021-04-11T10:52:24.756Z"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "609d7eea3373711346c5e953"
    },
    "orderItems": [
      {
        "$oid": "609d7ee93373711346c5e951"
    ...
    "totalPrice": 4161,
    "user": {
      "$oid": "609d65943373711346c5e950"
    },
    "dateOrdered": {
      "$date": "2021-05-13T19:32:58.030Z"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "609d874d3373711346c5e956"
    },
    "orderItems": [
      {
        "$oid": "609d874c3373711346c5e954"
    ...
    "dateOrdered": {
      "$date": "2021-05-13T20:08:45.299Z"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "609d898d3373711346c5e959"
    },
    "orderItems": [
      {
        "$oid": "609d898d3373711346c5e957"
    ...
    "dateOrdered": {
      "$date": "2021-05-13T20:18:21.264Z"
    },
    "__v": 0
  }, {
    "_id": {
      "$oid": "609d8a0c3373711346c5e95c"
    },
    "orderItems": [
      {
        "$oid": "609d8a0c3373711346c5e95a"
  ...
  getProductLists() {
    this.productsService.getProducts(1, 2)
      .subscribe(data => {
        // console.log(data);
        this.products = data;
      })
  ...
  paginate(event: any) {
    ...
    console.log(event);
    this.products = [];
    this.productsService.getProducts(page, perPage)
      .subscribe(data => {
        this.products = data;
      })
  }
  ...
  createCategory() {
    const category = Object.values(this.categoryData);
    // console.log(category);
    category.forEach(item => {
      const { color, icon, name, ...temp } = item;
      console.log(color, icon, name);
      this.categoriesService.createCategory({ color, icon, name })
      ...
      if (item.reviews !== undefined) {
        ...
        this.productsService.createProduct(product)
          ...
          .subscribe(id => {
            from(images)
              .pipe(
                concatMap((img) => this.productsService.createImage({ image: img, productid: id }))
              )
              .subscribe(data => {
            ...
            if (reviews.length > 0 && reviews !== undefined) {
              from(reviews)
                .pipe(
                  concatMap((data) => this.productsService.createReview({
                    avatar: data.avatar, name: data.name, review: data.review, productid: id
                  }))
                )
                .subscribe(data => {
  ...
  delete(id: number) {
    const result = confirm('삭제하시 겠습니까?');
    if (!result) {
      return;
    }
